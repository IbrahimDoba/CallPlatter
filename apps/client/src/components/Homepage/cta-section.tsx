...
export default function CTASection() {
  return (
    <section className="text-center py-20 mb-16 container mx-auto px-6">
      <motion.div
        className="bg-gradient-to-r from-blue-600 to-purple-700 rounded-3xl p-12 md:p-16 text-white shadow-2xl"
        whileHover={{ scale: 1.02 }}
        {...fadeInUp}
      >
        <h2 className="text-4xl md:text-6xl font-bold mb-6">Ready to Transform Your Business?</h2>
        <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90">
          Join thousands of Nigerian businesses that never miss a call with CallPlatter's AI receptionist
        </p>
